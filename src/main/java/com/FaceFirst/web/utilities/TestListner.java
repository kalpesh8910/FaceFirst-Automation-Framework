...
public class TestListner{/* implements ITestListener {
    ...
    String reportName = "TestExecutionReport.html";
    ...
    public void onTestFailure(ITestResult iTestResult) {
        try {
            ExtentManager.getTest().get().createNode(MarkupHelper.createLabel("Test Failed", ExtentColor.RED).getMarkup()).fail(iTestResult.getThrowable());
